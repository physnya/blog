---
url: /GR/lesson-9-schwarzschild-black-hole/index.md
---
::: warning
...
Freely Falling Particle starts to fall at $r=r\_0$：
$$
\left(\frac{\text{d}r}{\text{d}\tau}\right)^2 = E^2-\left(1-\frac{2GM}{r}\right) = 2GM\left(\frac{1}{r}-\frac{1}{r\_0}\right)
$$
可以解出一个参数方程，
$$
r=\frac{r\_0}{2}(1+\cos\eta),\quad \tau=\frac{r\_0}{2}\left(\frac{r\_0}{2GM}\right)^{1/2}(\eta+\sin\eta)
$$
...
$$
\begin{aligned}
\rho &= \int\_{2GM}^r g\_{rr}^{1/2}(r')\text{d}r' = \int\_{2GM}^r\left(1-\frac{2GM}{r'}\right)^{1/2}\text{d}r' \\\\
