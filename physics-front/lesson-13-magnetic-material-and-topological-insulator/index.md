---
url: /physics-front/lesson-13-magnetic-material-and-topological-insulator/index.md
---
::: center
...
$$
H = \sum\_{\langle ij\rangle}-J\bold{S}\_i\cdot\bold{S}\_j - \sum\_l\bold{B}\cdot\bold{S}*l
$$
前一项是相互作用能 (Heisenberg 给出)，后一项是 Zeeman 能. 现在人们研究的材料还多了一项
$$
\bold{D}*{ij}\cdot(\bold{S}\_i\times\bold{S}\_j)
$$
这一项给出手性的磁相互作用.
