---
url: /physics-front/lesson-8/index.md
---
::: center
...
* 光钟：把激光锁在一个极为稳定的光学谐振腔中间，能够将 $10^{15}\text{ Hz}$ 光频的光线宽锁定在 $1\text{ mHz}$ 量级. 但是这还不够好，最精确的东西永远是理论上的量子系统，只由几个物理常数来决定. 所以我们用刚才产生的高度单色光来照射超冷原子，之后比较原子受激辐射光频和高度单色光光频.
  ...
  具体实现是一个「喷泉」，在真空中超冷原子向上喷，经过微波区域原子就会随着微波进动 (激发态和基态的线性叠加，这之间存在一个相位差，$\ket{0}+e^{-\text{i}\omega\_0 t}\ket{1}$，发生进动)，之后经历一个自由上抛的过程，落回来时微波的相位按照微波频率 $\omega$ 变化，而原子进动按照原子固有频率 $\omega\_0$ 变化，这种干涉实际上就是在做原子固有频率和微波频率的比较.
