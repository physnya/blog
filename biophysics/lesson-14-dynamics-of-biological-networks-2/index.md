---
url: /biophysics/lesson-14-dynamics-of-biological-networks-2/index.md
---
生物网络：
...
一维正反馈效应：
$$
\frac{\text{d}\[x]}{\text{d}t}=v\frac{\[x]^n}{K\_d^n+\[x]^n} - d\cdot\[x]
$$
...
$$
u\_0=\frac{\alpha}{1+v\_0^n},\quad v\_0=\frac{\alpha}{1+u\_0^n}\Longrightarrow\frac{\text{d}}{\text{d}t}\begin{pmatrix}
\delta u\\\delta v
