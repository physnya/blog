---
url: /biophysics/lesson-7-polymer/index.md
---
...
$$
\frac{\Delta S}{Nk\_B}=-x\_A\ln x\_A-(1-x\_A)\ln(1-x\_A),,\quad x\_A+x\_B=1
$$
...
$$
zN\_A=2m\_{AA}+m\_{AB},\quad zN\_B=2m\_{BB}+m\_{AB}
$$
所以能量项里面，
$$
\frac{U}{N}=\frac{1}{2} zw\_{AA}x\_A^2+\frac{1}{2}zw\_{BB}(1-x\_A)^2+zw\_{AB}x\_A(1-x\_A)
$$
