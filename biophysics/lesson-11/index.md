---
url: /biophysics/lesson-11/index.md
---
马达的运动，实际上动力来源于膜两侧的电化学势差，
$$
U=qV+k\_BT\ln c\Longrightarrow\Delta U=q\Delta V+k\_BT\ln\frac{c\_{\text{out}}}{c\_{\text{in}}}
$$
...
生长方程：
$$
\frac{\text{d}P\_n}{\text{d}t}=k\_{\text{on}}P\_{n-1}P\_1+k\_{\text{off}}P\_{n+1}-(k\_{\text{on}}P\_1+k\_{\text{off}})P\_n
$$
其中 $k\_{\text{on}}$ 和 $k\_{\text{off}}$ 分别是链的两端结合新的单元和解离旧的单元的速率常数. 平均长度是
$$
\langle L\rangle=\sum\_{n=1}^\infty naP\_n
$$
