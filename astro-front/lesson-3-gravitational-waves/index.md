---
url: /astro-front/lesson-3-gravitational-waves/index.md
---
::: right
...
我们测量引力波是通过度规相对当前度规的偏移得到的，$h\_{jk}$. 广义相对论给出这个关系：

$$
h\_{jk}\sim\frac{\ddot{I}\_{jk}}{r}
$$
...
当然，在更高的质量下也观测到一些事件，比如 GW190521 观测到 $85M\_{\odot}$ 和 $66M\_\odot$ 合并.
