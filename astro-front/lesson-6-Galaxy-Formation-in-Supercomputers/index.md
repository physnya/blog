---
url: /astro-front/lesson-6-Galaxy-Formation-in-Supercomputers/index.md
---
::: right
...
每个单元的运动方程是
$$
\ddot{\vec{x}}\_i=-\nabla\_i\varPhi(\vec{x}*i),,\quad\varPhi(\vec{x})=-G\sum*{j=1}^N\frac{m\_j}{\[(\vec{x}-\vec{x}\_j)^2+\varepsilon^2]^{1/2}}\tag{1}
$$
