---
url: /astro-front/lesson-4-gravitational-lensing/index.md
---
::: right
...
* 1973 - 1980，Roberts & Rots; Rubin *et al*：测量 $\text{H}$ 的 $21\text{ cm}$ 谱线，也证明存在 dark matter.
...
$$
\varPhi(b,z)=-\frac{GM}{(b^2+z^2)^{1/2}}\Longrightarrow\nabla\_\bot\varPhi(b,z)=\frac{GM\vec{b}}{(b^2+z^2)^{3/2}}
$$

积分角度，得到

$$
\alpha = \frac{2}{c^2}\int\nabla\_\bot\varPhi\text{d}z=\frac{4GM}{c^2b}
$$
...
$$
\theta\_E=\left\[\frac{4GM(\theta\_E)}{c^2}\frac{D\_{ds}}{D\_dD\_s} \right]^{1/2}
$$

这是所谓的 Einstein 圆环对应的角宽方程.

Zwicky 在 1930s 就提出，星系质量应该比当时认为的 $10^9M\_{\odot}$ 要大一百倍以上，也就是用 gravitational lensing 测量得到的 $10^{11}M\_\odot$ 量级. 这在 1950s 第一次观测到的类星体透镜事件中被验证.
...
> 首先，冷暗物质因为「冷」，所以在极其微小的尺度上很容易聚集，这造成 $10^6M\_\odot$ 量级的卫星星系应该有更多，而不是现在所观测到的那样.
>
