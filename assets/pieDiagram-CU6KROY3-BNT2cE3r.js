import{An as e,Br as t,Bt as n,En as r,Fn as i,Jn as a,Ln as o,Nn as s,Nt as c,Tt as l,Wr as u,Xn as d,_n as f,bn as p,hn as m,hr as h,sn as g,vr as _,yn as v,zr as y}from"./common-BPbsQUZs.js";var b=m.pie,x={sections:new Map,showData:!1,config:b},S=x.sections,C=x.showData,w=structuredClone(b),T={getConfig:u(()=>structuredClone(w),`getConfig`),clear:u(()=>{S=new Map,C=x.showData,s()},`clear`),setDiagramTitle:v,getDiagramTitle:e,setAccTitle:f,getAccTitle:o,setAccDescription:r,getAccDescription:g,addSection:u(({label:e,value:t})=>{if(t<0)throw Error(`"${e}" has invalid value: ${t}. Negative values are not allowed in pie charts. All slice values must be >= 0.`);S.has(e)||(S.set(e,t),_.debug(`added new section: ${e}, with value: ${t}`))},`addSection`),getSections:u(()=>S,`getSections`),setShowData:u(e=>{C=e},`setShowData`),getShowData:u(()=>C,`getShowData`)},E=u((e,n)=>{t(e,n),n.setShowData(e.showData),e.sections.map(n.addSection)},`populateDb`),D={parse:u(async e=>{let t=await y(`pie`,e);_.debug(t),E(t,T)},`parse`)},O=u(e=>`
  .pieCircle{
