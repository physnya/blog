import{$r as e,Ct as t,Fn as n,Jn as r,Mr as i,Pr as a,Qn as o,_n as s,ar as c,bn as l,er as u,fr as d,gr as f,jt as p,lr as m,ni as h,or as g,si as _,vr as v,wn as y}from"./common-BgCfwe9l.js";var b=g.pie,x={sections:new Map,showData:!1,config:b},S=x.sections,C=x.showData,w=structuredClone(b),T={getConfig:_(()=>structuredClone(w),`getConfig`),clear:_(()=>{S=new Map,C=x.showData,v()},`clear`),setDiagramTitle:o,getDiagramTitle:u,setAccTitle:m,getAccTitle:r,setAccDescription:c,getAccDescription:d,addSection:_(({label:e,value:t})=>{if(t<0)throw Error(`"${e}" has invalid value: ${t}. Negative values are not allowed in pie charts. All slice values must be >= 0.`);S.has(e)||(S.set(e,t),h.debug(`added new section: ${e}, with value: ${t}`))},`addSection`),getSections:_(()=>S,`getSections`),setShowData:_(e=>{C=e},`setShowData`),getShowData:_(()=>C,`getShowData`)},E=_((e,t)=>{l(e,t),t.setShowData(e.showData),e.sections.map(t.addSection)},`populateDb`),D={parse:_(async e=>{let t=await s(`pie`,e);h.debug(t),E(t,T)},`parse`)},O=_(e=>`
  .pieCircle{
