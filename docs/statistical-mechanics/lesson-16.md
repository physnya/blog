...
> 顺磁固体 $\ce{Gd2 (SO4)3  (H2O)8}$ 的顺磁性来自 $\ce{Gd^{3+}}$ 离子. $\ce{Gd^{3+}}$ 离子基态的谱项为 $^8S_{7/2}(L=0,J=S=7/2)$，试求在高温和低温极限下 $\ce{Gd2(SO4)3 (H2O)8}$ 的磁化率.
...
>
> $\ce{^{12}C}$ 原子；$\ce{^{13}C}$ 原子；$\ce{H2}$ 分子；$\ce{H-}$ 离子；$\ce{^3He}$ 原子；$\ce{^4He}$ 原子；$\alpha$ 粒子；正电子；$\ce{^6Li-}$ 离子.
