---
url: /quantum-mechanics/lesson-2/index.md
---
...
波函数的模平方是概率 $p=|\psi(x,t)|^2$，波函数由相位和振幅来确定 $\psi(x,t)=A(x,t)e^{-\text{i}\phi(x,t)}$. 在双缝实验中，我们考量的是单个粒子自己和自己的干涉，在屏上出现的概率是 $|\psi\_\text{up}+\psi\_\text{down}|^2$.
...
$$
\psi(x,t)=\int\_{-\infty}^\infty\text{d}x'\cdot\psi(x',t)\delta(x'-x)
$$
另外，波函数的模方应该是归一化的，经典上来说
$$
\int\_{-\infty}^\infty|\psi(x,t)|^2\text{d}x=1
$$
