---
url: /quantum-mechanics/lesson-6/index.md
---
...
对于自由度极多的系统，我们还是可以说：
$$
\[x^{(i)}, \hat{p}*x^{(j)}] = \text{i}\hbar\delta*{ij}
$$
...
$$
\psi\_0(x\_1)\psi\_0(x\_2)\cdots\psi(x\_n)
$$
(所有粒子都有同样的波函数，但是自由度极高，来自于总的粒子数)

Cooper 等人做的超导 BCS 理论和上述波函数其实很相似，只是 $\psi\_0$ 换成了 $\psi\_{\text{pair}}^{\uparrow\downarrow}(\vec{R}\_c,\vec{r})$，这里
$$
...
$$
\varPsi(x,t)=\frac{1}{\sqrt{2\pi}}\int\_{-\infty}^\infty\phi(t)e^{\text{i}(kx-\frac{\hbar k^2}{2m}t)}\text{d}k
$$
相当于很多不同频率的平面波叠加.
