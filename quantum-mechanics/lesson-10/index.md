---
url: /quantum-mechanics/lesson-10/index.md
---
11-03 期中考试.

对于势垒的 tunnelling，我们考虑入射波为 $e^{\text{i}kx}$，反射为 $re^{-\text{i}kx}$、透射为 $te^{\text{i}kx}$，在势垒中间的波函数是 $e^{\pm\kappa x}$. 一维 Schrödinger 方程：
$$
\left(-\frac{\hbar^2}{2m}\frac{\partial^2}{\partial x^2}+V\_0\right)\psi=\frac{\hbar^2k^2}{2m}\psi
$$
令
$$
\frac{\hbar^2\kappa^2}{2m}=V\_0-\frac{\hbar^2k^2}{2m}
$$
则得到势垒中间的波函数满足
$$
...
$$
\psi(x)=\int\psi\_ke^{\text{i}kx}\text{d}k
$$
