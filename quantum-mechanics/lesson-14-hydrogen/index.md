---
url: /quantum-mechanics/lesson-14-hydrogen/index.md
---
「最干净的三维量子力学问题」
...
氢原子光谱规律是
$$
\frac{1}{\lambda} = R\left(\frac{1}{n\_f^2}-\frac{1}{n\_i^2}\right)
$$
...
$$
\[L\_x,L\_y]=\text{i}\hbar L\_z,\quad\[L\_y,L\_z]=\text{i}\hbar L\_x,\quad\[L\_z,L\_x]=\text{i}\hbar L\_y
$$
因此角动量分量不能被同时确定.
