...
2. 降温：
   ...
   两种有效的辐射：原子气体的跃迁，需要的临界质量在 $10^8 M\_{\odot}$；分子气体的跃迁，需要的质量更小，在 $10^5\sim10^8M\_\odot$，被称为 mini halo.
...
$$
T\_{\text{vir}}=T\_{\text{sh}}=\frac{\mu m\_p}{2k\_B}v\_{\text{vir}}^2=3.6\times10^5\text{ K}\times\left(\frac{v\_{\text{vir}}}{100\text{ km/s}}\right)^2
$$
...
$$
R\propto\sigma\_0^a\braket{I}^b
$$
