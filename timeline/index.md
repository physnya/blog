...
* 功能 2024-07-22
  ...
  下载 [HCLonely](https://blog.hclonely.com/) 制作的 [Hexo 插件](https://github.com/HCLonely/hexo-bilibili-bangumi)，制作了一个 [⌈ 动画 ⌋](/bangumi/) 页面，此页面已失效.
...
* 功能 2024-08-02
  ...
  更换新的 [插件](https://github.com/ChiyukiRuon/hexo-bangumi-gallery)，重新设立 [⌈ 动画 ⌋](https://physnya.top/bangumi.html) 页面. 鸣谢插件的制作者 [千雪琉音](https://github.com/ChiyukiRuon)，此页面已失效.
...
* 功能 2024-08-09
  ...
  使用 noindex 避免被搜索引擎收录. 但是完全不被收录要等到下一次 bot 来这里巡逻，可能要一个多月.
...
* 友链 2024-09-11
  ...
  删除友链 [ScaredCube's Site](https://sccube.link).
